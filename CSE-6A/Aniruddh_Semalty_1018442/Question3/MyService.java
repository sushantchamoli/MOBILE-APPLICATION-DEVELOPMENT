//Aniruddh semalty Roll_No-1018442 Sec -A
...
public class MyService extends Service {
   ...
   //Aniruddh semalty Roll_No-1018442 Sec -A
    ...
    private int randomNumber;                                           //Aniruddh semalty Roll_No-1018442 Sec -A
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Toast.makeText(getApplicationContext(), "Service onStartCommand() method executed", Toast.LENGTH_SHORT); //Aniruddh semalty Roll_No-1018442 Sec -A
