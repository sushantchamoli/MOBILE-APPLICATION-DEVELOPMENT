...
public class q3main extends AppCompatActivity {

    private Button button1, button2, button3, button5;
    private ArrayList<Integer> list = new ArrayList<>();
    private TextView textView, textView2;
    private ServiceConnection serviceConnection = null;
    private q3service myService = null;
    private boolean isServiceBound = false;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.q3main);
        init();
    }
    private void init()
    {
    ...
    private void listener(){
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startService(new Intent(getApplicationContext(), q3service.class));
            }
        });
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                stopService(new Intent(getApplicationContext(), q3service.class));
            }
        });
        ...
        if(serviceConnection == null) {
            serviceConnection = new ServiceConnection() {
                ...
                public void onServiceConnected(ComponentName name, IBinder service) {
                    isServiceBound = true;
                    q3service.MyBinder myServiceBinder = (q3service.MyBinder) service;
            ...
            Intent serviceIntent = new Intent(getApplicationContext(), q3service.class);
