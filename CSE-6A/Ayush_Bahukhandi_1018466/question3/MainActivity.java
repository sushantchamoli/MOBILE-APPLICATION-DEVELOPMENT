    ...
    private void listener(){
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startService(new Intent(getApplicationContext(), NewActivity.class));
            }
        });
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                stopService(new Intent(getApplicationContext(), NewActivity.class));
            }
        });
        ...
        if(serviceConnection == null) {
            serviceConnection = new ServiceConnection() {
                ...
                public void onServiceConnected(ComponentName name, IBinder service) {
                    isServiceBound = true;
                    NewActivity.MyBinder myServiceBinder = (NewActivity.MyBinder) service;
            ...
            Intent serviceIntent = new Intent(getApplicationContext(), NewActivity.class);
